...
class Controller
{
    ...
    private function init(): void
    {
        global $env;
        try {
            // keep existing behavior of applying theme filter if available
            $env->theme = apply_filter('get_theme', $env->theme, \System\Config::get('app.theme'));
        } catch (Exception $e) {
            // swallow — keep boot resilient
        }
    }
