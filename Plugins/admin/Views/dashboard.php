                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="revenue-card text-center">
                                <div class="offer-img">
                                    <img src="<?= content_rul('media/') ?>bg-img/offer.jpg" alt="" />
                                </div>
                                <h6>Total Revenue</h6>
                                <h2>$40,000.00</h2>
                                <p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="product-list-area" id="product">
                                <!-- Product List -->
                                <div
                                    class="top-product-list d-flex align-items-center justify-content-between"
                                >
                                    <div
                                        class="product-meta-info d-flex align-items-center"
                                    >
                                        <div class="product-img">
                                            <img src="<?= content_rul('media/') ?>shop-img/1.png" alt="" />
                                        </div>
                                    ...
                                    <div
                                        class="product-number alert alert-primary rounded-pill px-3 py-1 mb-0"
                                    >
                                        36k
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="product-img">
                                            <img src="<?= content_rul('media/') ?>shop-img/2.png" alt="" />
                                        </div>
                                        <div class="product-info">
                                ...
                                >
                                    ...
                                    >
                                        <div class="product-img">
                                            <img src="<?= content_rul('media/') ?>shop-img/3.png" alt="" />
                                        </div>
                                        <div class="product-info">
                                ...
                                >
                                    ...
                                    >
                                        <div class="product-img">
                                            <img src="<?= content_rul('media/') ?>shop-img/4.png" alt="" />
                                        </div>
                                        <div class="product-info">
                                ...
                                >
                                    ...
                                    >
                                        <div class="product-img">
                                            <img src="<?= content_rul('media/') ?>shop-img/5.png" alt="" />
                                        </div>
                                        <div class="product-info">
                                            <span>New Watch</span>
                                            <p class="mb-0">$365</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="shiping-cart-meta-area" id="shiping">
                                ...
                                >
                                    <div class="shipping-progress">
                                        <label class="lable-text">Revenue Rate</label>
                                        <div
                                            class="progress h-6"
                                            role="progressbar"
                                            aria-label="Example with label"
                                ...
                                >
                                    <div class="shipping-progress">
                                        <label class="lable-text">Total Product</label>
                                        <div
                                            class="progress h-6"
                                            role="progressbar"
                                            aria-label="Example with label"
                                ...
                                >
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <img
                                                class="shop-img"
                                                src="<?= content_rul('media/') ?>shop-img/1.png"
                                                alt=""
                                            />
                                            <span>Sound Box</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <img
                                                class="shop-img"
                                                src="<?= content_rul('media/') ?>shop-img/3.png"
                                                alt=""
                                            />
                                            <span>Head Phone</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <img
                                                class="shop-img"
                                                src="<?= content_rul('media/') ?>shop-img/4.png"
                                                alt=""
                                            />
                                            <span>New Sound</span>
                                        </td>
...
[actions.footer priority="10"]
<!-- These plugins only need for the run this page -->
<script src="<?= theme_url(); ?>js/apexcharts.min.js"></script>
<script src="<?= theme_url(); ?>js/intro.min.js"></script>
<script src="<?= theme_url(); ?>js/dashboard-custom.js"></script>
<script src="<?= theme_url(); ?>js/intro-active.js"></script>
[/actions]