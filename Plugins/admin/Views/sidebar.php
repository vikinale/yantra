                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li> <a href="<?= site_url('admin/school/class'); ?>"><i class="fa fa-paperclip"></i><span>Class</span></a> </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li> <a href="<?= site_url('admin/branch/list'); ?>"><i class="fa fa-paperclip"></i><span>Branches</span></a> </li>
                            <li> <a href="<?= site_url('admin/branch/classrooms'); ?>"><i class="fa fa-paperclip"></i><span>Classrooms</span></a> </li>
                            <li> <a href="<?= site_url('admin/branch/groups'); ?>"><i class="fa fa-paperclip"></i><span>Student Groups</span></a> </li>
                        </ul>
                    </li>
