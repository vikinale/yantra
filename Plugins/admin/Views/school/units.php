        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="card">
                    ...
                    [/array]
                    [/array]
                    [ll.pc.breadcrumb "{breadcrumb_list}" title="Unit" /]
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex">
                            <div><h3 class="card-title"> <?= (isset($record['ID'])?"Update ":'Create New'); ?> Unit</h3></div>
                            <div class="text-right flex-grow-1">
                                <?php if(isset($record['ID'])): ?>
                                    <a href="[get env.site_url/]/admin/school/units" class="btn btn-outline-info">Add New</a>
                                <?php endif; ?>
                            </div>
                        </div>
                        [form.createform post action="{site_url}/admin/school/units/create"]
                            ...
                            <?php endif; ?>
                            [ll.form-controls.input  id="unit_name" name="unit_name" label="Unit Name" value="<?= $record['unit_name']??''; ?>" /]
                            [ll.form-controls.input  id="short_code" name="short_code" label="Short Code" value="<?= $record['code']??''; ?>" /]
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8 text-center">[ll.form-controls.submit  id="record_submit" name="record_submit" value="Save Unit" /]</div>
                                <div class="col"></div>
                            </div>
                        [/form]
                ...
                <div class="card card-h-100">
                    <div class="card-body">
                        <div class="card-title">
                            <h2 class="card-title">Unit List</h2>
                        </div>
